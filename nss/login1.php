<?php
   ...
   define('DB_PASSWORD', 'wmo_16_17');
   define('DB_DATABASE', 'nss_17_18');
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if($count == 1) {
         setcookie("access","joeydash", time() + (86400 * 30), "/");  
         header("location: https://nss.iitm.ac.in/blogs/");
      }else {
         echo '<script>
...
<body>
	...
	<div class="topnav" id="myTopnav" style="padding:10px 20px 10px 20px">
		<img src="icon.png" height="70"; width="70"></img>Login Portal
	...
	<form  method="post"  action="login1.php" style="padding-top:120px">
